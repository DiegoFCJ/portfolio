        ...
        projects: [
            {
                ...
                technologies: ['Angular 17', 'TypeScript', 'Tailwind CSS', 'Firebase Hosting'],
                description: 'Responsivt turistnettsted som fremhever kystlandsbyen med kuraterte ruter, sesonggalleri og CMS-styrt tekst (privat kode).',
                image: 'assets/projects/borgo-samarina-cover.png',
                links: {
                    code: {
                        state: 'private'
            ...
            },
            {
                ...
                technologies: ['Angular 16', 'TypeScript', 'RxJS', 'SCSS', 'Node.js'],
                description: 'Modulær samling av uformelle minispill med delt kjerne, spillerprofiler og mobilklar toppliste for korte økter.',
                image: 'https://github.com/DiegoFCJ/MicroGames/blob/master/overview/loggedPage.png?raw=true',
                links: {
                    code: {
                        state: 'unavailable'
            ...
            },
            {
                ...
                technologies: ['Angular 17', 'NestJS', 'PostgreSQL', 'Docker', 'Redis'],
                description: 'Produktivitetssenter som sporer vaner, tilbyr et plugin-marked og synkroniserer mål med kalenderpåminnelser på tvers av enheter.',
                image: 'https://github.com/DiegoFCJ/self/blob/master/self.png?raw=true',
                links: {
                    code: {
                        state: 'unavailable'
            ...
            },
            {
                ...
                technologies: ['Spring Boot 3', 'Angular 17', 'MySQL', 'Keycloak', 'Docker'],
                description: 'Headless netthandelsmal med modulær checkout, lagerflyter og administratordashboard klart for ERP-integrasjoner.',
                image: 'https://github.com/DiegoFCJ/E-commerce/blob/master/overview/homeSideDash.png?raw=true',
                links: {
                    code: {
                        state: 'available',
        ...
        projects: [
            {
                ...
                technologies: ['Angular 17', 'TypeScript', 'Tailwind CSS', 'Firebase Hosting'],
                description: 'Адаптивный туристический портал, посвящённый приморскому городку, с подобранными маршрутами, сезонной галереей и текстами из headless CMS (приватный код).',
                image: 'assets/projects/borgo-samarina-cover.png',
                links: {
                    code: {
                        state: 'private'
            ...
            },
            {
                ...
                technologies: ['Angular 16', 'TypeScript', 'RxJS', 'SCSS', 'Node.js'],
                description: 'Модульный набор казуальных мини-игр с общей основой, профилями игроков и мобильным рейтингом для коротких сессий.',
                image: 'https://github.com/DiegoFCJ/MicroGames/blob/master/overview/loggedPage.png?raw=true',
                links: {
                    code: {
                        state: 'unavailable'
            ...
            },
            {
                ...
                technologies: ['Angular 17', 'NestJS', 'PostgreSQL', 'Docker', 'Redis'],
                description: 'Центр продуктивности, который отслеживает привычки, предлагает маркетплейс плагинов и синхронизирует цели с календарными напоминаниями на всех устройствах.',
                image: 'https://github.com/DiegoFCJ/self/blob/master/self.png?raw=true',
                links: {
                    code: {
                        state: 'unavailable'
            ...
            },
            {
                ...
                technologies: ['Spring Boot 3', 'Angular 17', 'MySQL', 'Keycloak', 'Docker'],
                description: 'Шаблон headless e-commerce с модульным checkout, складскими процессами и админ-панелью, готовой к интеграции с ERP.',
                image: 'https://github.com/DiegoFCJ/E-commerce/blob/master/overview/homeSideDash.png?raw=true',
                links: {
                    code: {
                        state: 'available',
