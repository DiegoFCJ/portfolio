...
export const skills: Skill[] = [
    {
        ...
        skills: [
            { name: "C#", icon: "https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=csharp&logoColor=white", clicked: false },
            ...
            { name: "PowerShell", icon: "https://img.shields.io/badge/PowerShell-%235391FE.svg?style=for-the-badge&logo=powershell&logoColor=white", clicked: false },
            { name: "Shell Script", icon: "https://img.shields.io/badge/shell_script-%23121011.svg?style=for-the-badge&logo=gnu-bash&logoColor=white", clicked: false },
            { name: "YAML", icon: "https://img.shields.io/badge/yaml-%23ffffff.svg?style=for-the-badge&logo=yaml&logoColor=151515", clicked: false },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Angular.js", icon: "https://img.shields.io/badge/angular.js-%23E23237.svg?style=for-the-badge&logo=angularjs&logoColor=white", clicked: false },
            ...
            { name: "SASS", icon: "https://img.shields.io/badge/SASS-hotpink.svg?style=for-the-badge&logo=SASS&logoColor=white", clicked: false },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: ".NET", icon: "https://img.shields.io/badge/.NET-5C2D91?style=for-the-badge&logo=.net&logoColor=white", clicked: false },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Postgres", icon: "https://img.shields.io/badge/postgres-%23316192.svg?style=for-the-badge&logo=postgresql&logoColor=white", clicked: false },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Windows Terminal", icon: "https://img.shields.io/badge/Windows%20Terminal-%234D4D4D.svg?style=for-the-badge&logo=windows-terminal&logoColor=white", clicked: false },
        ]
    },
    {
        title: "Versioning",
