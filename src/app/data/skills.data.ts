...
export const skills: SkillFullLangs = {
    ...
    no: {
        ...
        skills: [
            ...
            {
                title: 'Back-end · Integrasjon og automasjon',
            ...
            {
                title: 'Front-end · Språk og fundament',
            ...
            },
            {
                ...
                subtitle: 'Komponentbiblioteker og verktøy for responsivt design',
                skills: [
                    {
                        name: 'SCSS',
                        icon: 'https://img.shields.io/badge/SCSS-hotpink.svg?style=for-the-badge&logo=sass&logoColor=white',
            ...
            {
                title: 'DevOps · CI/CD',
                subtitle: 'Automatisering av bygg og leveranseløp',
                skills: [
                    {
                        name: 'Gradle',
                        icon: 'https://img.shields.io/badge/Gradle-02303A.svg?style=for-the-badge&logo=gradle&logoColor=white',
            ...
            },
            {
                ...
                subtitle: 'Administrert PaaS- og BaaS-hosting',
                skills: [
                    {
                        name: 'Heroku',
                        icon: 'https://img.shields.io/badge/Heroku-430098?style=for-the-badge&logo=heroku&logoColor=white',
            ...
            {
                title: 'DevOps · Skripting og konfigurasjon',
                subtitle: 'Infrastrukturautomatisering og shell-skript',
                skills: [
                    {
                        name: 'YAML',
                        icon: 'https://img.shields.io/badge/YAML-CB171E?style=for-the-badge&logo=yaml&logoColor=white',
            ...
            {
                title: 'DevOps · Versjonering',
                subtitle: 'Distribuert versjonskontroll og repository',
                skills: [
                    {
                        name: 'Git',
                        icon: 'https://img.shields.io/badge/git-%23F05033.svg?style=for-the-badge&logo=git&logoColor=white',
            ...
            },
            {
                ...
                subtitle: 'Kreative suiter og kontorverktøy',
                skills: [
                    {
                        name: 'Adobe Photoshop',
                        icon: 'https://img.shields.io/badge/Adobe%20Photoshop-31A8FF?style=for-the-badge&logo=adobephotoshop&logoColor=white',
    ...
    ru: {
        ...
        skills: [
            ...
            },
            {
                ...
                subtitle: 'Компонентные библиотеки и инструменты адаптивного дизайна',
                skills: [
                    {
                        name: 'SCSS',
                        icon: 'https://img.shields.io/badge/SCSS-hotpink.svg?style=for-the-badge&logo=sass&logoColor=white',
            ...
            {
                title: 'DevOps · CI/CD',
                subtitle: 'Автоматизация сборки и конвейеры доставки',
                skills: [
                    {
                        name: 'Gradle',
                        icon: 'https://img.shields.io/badge/Gradle-02303A.svg?style=for-the-badge&logo=gradle&logoColor=white',
            ...
            },
            {
                ...
                subtitle: 'Управляемый хостинг PaaS и BaaS',
                skills: [
                    {
                        name: 'Heroku',
                        icon: 'https://img.shields.io/badge/Heroku-430098?style=for-the-badge&logo=heroku&logoColor=white',
            ...
            {
                title: 'Инструменты · Продуктивность и дизайн',
